...
public class MostrarDatosPersonales extends javax.swing.JFrame {
    private Paciente p;
    /**
     * Creates new form MostrarDatosPersonales
     */
    public MostrarDatosPersonales(Paciente p) {
        super("Datos Personales del Paciente");
        this.p=p;
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ModificarDatosPersonales modD = new ModificarDatosPersonales(this.p);
